...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  /* ---- cover ---- */
  header.cover { padding: 20vh 0 40px; text-align: center; border-bottom: 1px solid var(--line); }
  .cover-mark { font-size: 15px; font-weight: 800; letter-spacing: 4px; color: var(--gold); }
  .cover-title { font-size: 52px; font-weight: 900; letter-spacing: -1px; margin: 14px 0 4px; }
  .cover-subtitle { font-size: 15px; font-weight: 700; letter-spacing: 3px; color: var(--text-dim); text-transform: uppercase; }
  .cover-year { font-size: 13px; color: var(--text-faint); margin-top: 26px; }
  ...
  @media print {
    ...
    header.cover { break-after: page; padding-top: 8vh; }
